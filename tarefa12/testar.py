...
class Task(BaseTask):
    def teste_1_sem_operacao(self):
        binary = self.compile(binary="planilha")
        self.test_cases(binary, self.case_range("planilha{}.in", 1, 4))
    def teste_2_op_binaria_com_ciclo(self):
        binary = self.compile(binary="planilha")
        self.test_cases(binary, self.case_range("planilha{}.in", 5, 7))
    def teste_3_exp_arbitraria(self):
        binary = self.compile(binary="planilha")
        self.test_cases(binary, self.case_range("planilha{}.in", 8, 10))
