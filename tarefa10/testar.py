...
class Task(BaseTask):
    def teste_1_corretor(self):
        binary = self.make("corretor")
        self.test_cases(binary, self.case_range("corretor{}.in", 1, 7))

    def teste_2_corretor(self):
        binary = self.make("corretor")
        self.test_cases(binary, self.case_range("corretor{}.in", 8, 10))
