...
class Task(BaseTask):
    def teste_1_tarefa02(self):
        binary = self.make("professor_carlos")
        self.test_cases(binary, self.case_range("tarefa02_{}.in", 1, 5))

    def teste_2_tarefa02(self):
        binary = self.make("professor_carlos")
        self.test_cases(binary, self.case_range("tarefa02_{}.in", 6, 15))
