...
class Task(BaseTask):
    def teste_1_frequencia(self):
        binary = self.make("listas_legais")
        self.test_cases(binary, self.case_range("listas_legais{}.in", 1, 2))

    def teste_2_frequencia_e_adicionar(self):
        binary = self.make("listas_legais")
        self.test_cases(binary, self.case_range("listas_legais{}.in", 3, 5))

    def teste_3_listas_legais(self):
        binary = self.make("listas_legais")
        self.test_cases(binary, self.case_range("listas_legais{}.in", 6, 8))

    def teste_4_todas_operacoes(self):
        binary = self.make("listas_legais")
        self.test_cases(binary, self.case_range("listas_legais{}.in", 9, 10))
