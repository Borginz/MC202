...
class Task(BaseTask):
    def teste_1_casos_simples(self):
        binary = self.compile(binary="caminho")
        self.test_cases(binary, self.case_range("caminho{}.in", 1, 6))

    def teste_2_mais_nos_e_distancia_maior(self):
        binary = self.compile(binary="caminho")
        self.test_cases(binary, self.case_range("caminho{}.in", 7, 8))

    def teste_3_muitos_nos_muito_distantes(self):
        binary = self.compile(binary="caminho")
        self.test_cases(binary, self.case_range("caminho{}.in", 9, 10))
